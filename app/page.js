  ...
  const services = [
    {
      ...
      image: '/NearForceWeb/images/SFImp',
    },
    {
...
<h1 className="text-5xl font-bold leading-tight mb-6">
  ...
  <span className="bg-gradient-to-br from-blue-600 via-blue-500 to-cyan-400 bg-clip-text text-transparent">
    Salesforce Excellence
            ...
            <div className="flex-1 mt-0 md:-mt-24 relative h-96">
            <VectorGlobe />
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="flex-1 relative h-[500px]">
              <Image
                src="/NearForceWeb/images/office.jpg"
                alt="About Us Image"
                layout="fill"
                objectFit="cover"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 relative h-[600px]">
              <Image
                src="/NearForceWeb/images/together.jpg"
                alt="Contact Image"
                layout="fill"
                objectFit="cover"
                className="rounded-lg"
            ...
            <div className="flex-1">
              <Card className="p-6">
                ...
                <form action="https://formsubmit.co/3f5aae38074b70c326852cf91dc8db1c" method="POST" className="space-y-4">
