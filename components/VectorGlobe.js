...
const countries = {
  ...
  otherCountries: [
    ...
    [26.1, 18.2, 21.8, 37.1, 23.6, 60.6, 3.9, 73.8, -6.9, 66.2, -23.2, 65.0,
     ...
     11.5, 0.6, 26.1, 18.2],
    // Asia
    [76.6, 81.8, 86.9, 113.0, 88.2, 131.6, 84.3, 139.0, 79.5, 152.9, 81.1, 170.5, 75.0, 188.2, 75.9, 197.6, 69.5, 213.3, 68.2, 201.7, 63.7, 197.6, 62.1, 189.8, 64.7, 179.2, 59.9, 164.4, 53.1, 155.4, 49.3, 163.8, 39.0, 158.0, 33.8, 149.0, 32.5, 139.7, 22.3, 142.6, 15.5, 137.4, 14.2, 127.8, 10.0, 126.8, 6.8, 129.7, 1.0, 127.8, 5.9, 118.8, 14.5, 111.4, 10.0, 105.9, 8.4, 100.8, 4.2, 101.1, -0.3, 97.9, 8.7, 93.1, 15.2, 93.1, 20.6, 71.8, 28.4, 66.7, 34.5, 66.7, 29.6, 55.1, 30.0, 44.2, 35.6, 38.5, 39.1, 31.1, 37.2, 24.3, 30.3, 20.4, 29.6, 14.9, 34.8, 11.4, 37.7, 12.7, 38.0, 19.1, 50.2, 21.4, 54.6, 40.4, 70.8, 61.9, 76.6, 81.8],
    // Australia
